...
добавить зону для отрисовки графика;
заменить кнопку "Calculate metrics" на кнопку "Calculate and Draw".
...
Реализация ограничения по годам, задаваемое пользователем.
Возможность построения графиков по нескольким регионам одновременно.
Заменить поля для ввода на выпадающие списки с возможными значениями.
